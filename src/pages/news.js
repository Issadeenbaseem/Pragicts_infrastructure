...
const reviews = [
    {
        id: 1,
        text: "PragICTS secures the Unicorn Metalics ( https://www.unicornmetalics.com/ ) Internet access through the implementation of Fortinet Firewall Appliance ( https://www.fortinet.com/ )",
        client: 'Unicorn Metalics',
        date: '12th August 2021',
        image: UnicornMetalicsIcon,
        link: 'https://www.unicornmetalics.com/ '
    },
    {
        id: 2,
...
const AboutUsPage = () => {
    return (
        <Layout pageTitle="infrastructure | News">
