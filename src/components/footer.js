                                ...
                                <div className="footer-box fl-wrap">
                                    <div className="footer-contacts fl-wrap">
                                        ...
                                        <ul>
                                            ...
                                            <li><i className="fal fa-envelope"></i><span>Email :</span><a href="mailto:infrastructure@pragicts.com">infrastructure@pragicts.com</a></li>
                                        </ul>
                                    </div>
                                    <div className="footer-contacts fl-wrap">
                                        <p>Support</p>
                                    ...
                                    <div className="footer-contacts fl-wrap">
                                        <p>Escalations</p>
                                        <ul>
                                            <li><i className="fal fa-phone"></i><span>Phone :</span><a href="tel:+94 70 4598 983 ">+94  70 4598 983 </a></li>
                ...
                <div className="subfooter fl-wrap">
                    <div className="container">
                        <div className="policy-box">
                            <span>&#169; PragICTS 2022  |  All rights reserved. </span>
                        </div>
